////program for SLICImageFilter
//01: based on template_vec.cxx and https://github.com/blowekamp/itkSuperPixel/blob/9e5983053432df8a4a23bd918d499c309fa2b00a/test/itkSLICImageFilterTest.cxx
...
int DoIt(int argc, char *argv[]){
    ...
    filter->SetSuperGridSize(atoi(argv[4]));
    filter->SetEnforceConnectivity(atoi(argv[5]));
