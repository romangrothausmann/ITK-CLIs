////program to add a constant to an image
...
int DoIt(int argc, char *argv[]){
    ...
    typedef itk::AddImageFilter<InputImageType, OutputImageType, OutputImageType> FilterType;
    typename FilterType::Pointer filter= FilterType::New();
    filter->SetInput(input);
    filter->SetConstant2(static_cast<OutputPixelType>(atof(argv[4])));
