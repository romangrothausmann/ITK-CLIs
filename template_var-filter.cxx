...
template<typename InputComponentType, size_t NumComponents, typename InputPixelType, size_t Dimension, typename InputImageType, typename OutputImageType, typename FilterType>
...
int DoIt(int argc, char *argv[]){
    ...
    case 0: {
        ...
        res= DoIt2<InputComponentType, NumComponents, InputPixelType, Dimension, InputImageType, OutputImageType, FilterType>(argc, argv, filter);
	} break;
    default:
